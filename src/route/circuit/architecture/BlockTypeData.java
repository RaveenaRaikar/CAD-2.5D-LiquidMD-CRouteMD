...
class BlockTypeData implements Serializable {
    ...
    BlockType addType(
            ...
            double fcOut,
            boolean clocked,
            Map<String, Pair<Integer, Boolean>> inputs,
            Map<String, Pair<Integer, Boolean>> outputs,
            Map<String, Pair<Integer, Boolean>> clocks) {
    ...
    double getFcIn(int typeIndex) {
    	return this.fcIn.get(typeIndex);
    }
    double getFcOut(int typeIndex) {
    	return this.fcOut.get(typeIndex);
    }
